...
class Engine {
 protected:
  ...
  //added by students
  void renderMyHomeworkUi(unsigned int object, int time);
  void orbitalTrajectory(SceneObject ship, SceneObject planet, int max_steps, bool recalculate);
